...
//        (0x01A9EF, 1) #e85352
        _weakButton.layer.borderColor=[UIColor colorWithHexString:@"#01A9EF"].CGColor;
        _weakButton.layer.borderWidth=1;
        [_weakButton setTitleColor:[UIColor colorWithHexString:@"#01A9EF"] forState:UIControlStateNormal];
    ...
    }
    {
        ...
        _monthButton.layer.borderColor=[UIColor colorWithHexString:@"#01A9EF"].CGColor;
        _monthButton.layer.borderWidth=1;
        [_monthButton setTitleColor:[UIColor colorWithHexString:@"#01A9EF"] forState:UIControlStateNormal];
    ...
    }
    {
        ...
        _threeMonthButton.layer.borderColor=[UIColor colorWithHexString:@"#01A9EF"].CGColor;
        _threeMonthButton.layer.borderWidth=1;
        [_threeMonthButton setTitleColor:[UIColor colorWithHexString:@"#01A9EF"] forState:UIControlStateNormal];
...
//        _headerView.backgroundColor = [UIColor yellowColor];
    ...
    {
//        106
        _middleView.frame= CGRectMake(0, _appearance.headerHeight, supWidth, AdaptationH(66));
...
//        _weakButton.backgroundColor = [UIColor redColor];
    ...
    {
//        41
        _currentDataSuperView.frame=CGRectMake(0, AdaptationH(65), supWidth, AdaptationH(1));
//        _currentDataSuperView.backgroundColor = [UIColor greenColor];

    }
    {
//        41
        _currentDataLabel.frame=CGRectMake(0, 0, supWidth, AdaptationH(1));
        
//        _currentDataLabel.backgroundColor = [UIColor orangeColor];

    }
    {
        _datePicker.frame = CGRectMake(0, _appearance.headerHeight+AdaptationH(90 -40), supWidth, supHeight - _appearance.headerHeight - _appearance.buttonHeight);
//        _datePicker.backgroundColor = [UIColor  purpleColor];
    }
    {
...
- (void)show
{
    ...
    [self performSelector:@selector(userChoose) withObject:nil afterDelay:1];
}

//完全出现后 才可以点击 避免 连续点击 选中 三个月按钮
-(void)userChoose{
