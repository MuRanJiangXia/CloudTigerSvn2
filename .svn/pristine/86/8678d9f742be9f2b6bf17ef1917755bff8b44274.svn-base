...
@implementation ChangeTopRateOperationCell
...
-(void)createUI{
    ...
    [button setTitle:@"修改上级费率" forState:UIControlStateNormal];
...
-(void)refundAction:(UIButton *)btn{
    NSLog(@"跳转查询");
    if ([self.delegete respondsToSelector:@selector(jumpChangeTopRate)]) {
        [self.delegete jumpChangeTopRate];
    }
