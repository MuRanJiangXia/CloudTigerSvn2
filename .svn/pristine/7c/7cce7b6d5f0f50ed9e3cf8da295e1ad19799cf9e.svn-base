...
@interface RefundViewController ()<UITableViewDelegate,UITableViewDataSource,QueryCellDelegate,QueryFooterDelegate,QueryCell2Delegate,QueryNewOrderCellDelegate>{
