...
@interface RefunQueryResulVC ()<UITableViewDelegate,UITableViewDataSource>{
...
@implementation RefunQueryResulVC
...
//            _table.footer.state = MJRefreshFooterStateNoMoreData;
            ...
            for (NSDictionary* dic in modelArr) {
                ...
                RefundQueryNewModel *model = [[ RefundQueryNewModel alloc]init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    QueryRefundNewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"QueryRefundNewCell" forIndexPath:indexPath];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    RefundQueryDesVC *query = [RefundQueryDesVC new];
    RefundQueryNewModel *model = _queryResultArr[indexPath.row];
