...
#import "QueryModel.h"
@interface ShopQueryViewController ()<UITableViewDelegate,UITableViewDataSource,QueryCellDelegate,QueryFooterDelegate,QueryCell2Delegate>{
...
//    [button addTarget:self action:@selector(shopListAction:) forControlEvents:UIControlEventTouchUpInside];
