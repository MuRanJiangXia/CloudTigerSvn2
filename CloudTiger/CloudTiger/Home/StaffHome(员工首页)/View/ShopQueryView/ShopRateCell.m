...
-(void)createUI{
    ...
    [button setTitle:@"费率订单查询" forState:UIControlStateNormal];
...
-(void)refundAction:(UIButton *)btn{
    NSLog(@"跳转查询");
    if ([self.delegete respondsToSelector:@selector(jumpShopRate)]) {
        [self.delegete jumpShopRate];
    }
