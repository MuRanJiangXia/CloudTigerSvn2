...
@implementation ShopPowerShowCell{
...
-(void)setShopPowerModel:(ShopPowerModel *)shopPowerModel{
    
    if (_shopPowerModel != shopPowerModel) {
        _shopPowerModel = shopPowerModel;
        [self setNeedsLayout];
    }
}
...
-(void)layoutSubviews{
    ...
    _firstLab.text = [NSString stringWithFormat:@"%@",_shopPowerModel.RoleName];
    
    _chooseView.on= _shopPowerModel.isChoose;
}
