...
@interface StaffPowerOperationVC ()<UITableViewDelegate,UITableViewDataSource,AssignStaffDelegate>{
...
@implementation StaffPowerOperationVC
...
#warning  SystemRoleSysNo 权限 id
    ...
    //    31 大学 ——交易订
    //    添加商户权限
    NSString *url  =[BaseUrl stringByAppendingString:StaffAddPowerUrl];
...
#warning 从上一个页面获取
    ...
    //    该商户权限
    NSString *url  =[BaseUrl stringByAppendingString:StaffDeletePowerUrl];
